...
def add_client(cur, name, surname, email, tel=None):
    cur.execute("""
...
if __name__ == '__main__':
    with psycopg2.connect(database="clients_db", user="postgres",
        ...
        with conn.cursor() as curs:
            ...
            print("Добавлен клиент id: ",
                  add_client(curs, "Константин", "Дементьев",
                                "vubx0t@mail.ru", 79993318644))
            print("Добавлен клиент id: ",
                  add_client(curs, "Гордей", "Виноградов",
                                "c0pu@outlook.com", 79933314644))
            print("Добавлен клиент id: ",
                  add_client(curs, "Емельян", "Юнусов",
                                "k8sjebg1y@mail.ru", 79913312643))
            print("Добавлена клиент id: ",
                  add_client(curs, "Карл", "Евдокимов",
                                "19dn@outlook.com"))
